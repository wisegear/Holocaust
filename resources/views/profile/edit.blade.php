	...
	<div class="my-10 w-1/2 mx-auto">
		<div class="flex flex-col space-y-6">
			  ...
			  <div class="">
			    ...
			    <input type="text" class="border rounded-md w-full" id="twitter" name="twitter" value="{{ $user->twitter }}">
			  </div>
			  ...
			  <button type="submit" class="border rounded-md py-1 px-2 bg-yellow-300 w-1/3 mx-auto">Update Profile</button>
		</form>
		</div>
	</div>
</div>
